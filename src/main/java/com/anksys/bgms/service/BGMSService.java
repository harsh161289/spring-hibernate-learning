...
public interface BGMSService {
	...
	boolean registerExecuter(String userID, String password, String role) throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException;
